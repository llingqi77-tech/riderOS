...
export const CITIES: Record<CityId, CityProfile> = {
  lagos: {
    ...
    todaySnapshot: {
      dailyIncome: 6500,
      todayTarget: 7000,
      dailyEta: '~40 min to target',
      ordersCompleted: 9,
      onlineHours: 5.5,
      aiInsight:
        "Your net per order is 8% higher than yesterday. Two more orders (~40 min) will hit today's ₦7,000 target.",
    },
    ...
    incomeRecords: [
      ...
      { recordId: 'rec_l3', riderId: 'rider_aminu', type: 'expense', category: 'fuel', amount: 1200, timestamp: iso(-280), note: 'Fuel 3L' },
      ...
      { recordId: 'rec_l6', riderId: 'rider_aminu', type: 'expense', category: 'food', amount: 600, timestamp: iso(-180), note: 'Lunch' },
      ...
      { recordId: 'rec_l9', riderId: 'rider_aminu', type: 'expense', category: 'maintenance', amount: 500, timestamp: iso(-40), note: 'Flat tire repair' },
    ],
    incomeTrend: {
      today: [
      ...
      week: [
        { label: 'Mon', income: 7200, expense: 2600 },
        { label: 'Tue', income: 6800, expense: 2400 },
        { label: 'Wed', income: 8100, expense: 2900 },
        { label: 'Thu', income: 5900, expense: 2200 },
        { label: 'Fri', income: 9200, expense: 3300 },
        { label: 'Sat', income: 10400, expense: 3600 },
        { label: 'Sun', income: 8200, expense: 3400 },
      ],
      month: [
        { label: 'Week 1', income: 48000, expense: 17000 },
        { label: 'Week 2', income: 52000, expense: 18500 },
        { label: 'Week 3', income: 46000, expense: 16000 },
        { label: 'Week 4', income: 55800, expense: 19200 },
      ],
    },
    incomeSummary: {
    ...
    incomeBreakdown: {
      ...
      expenses: [
        ...
        { name: 'Food', value: 600 },
        { name: 'Repair', value: 500 },
        { name: 'Platform fee', value: 1600 },
      ],
    },
    nextRepayment: {
      scheduleId: 'sch_018',
    ...
    repaymentAnalysis: {
      ...
      attainmentRate: 0.78,
      gap: -500,
      overtimeSuggestion: 'About ₦500 short this week — one extra order before due date should cover it.',
    },
  ...
  nairobi: {
    ...
    todaySnapshot: {
      dailyIncome: 4200,
      todayTarget: 5500,
      dailyEta: '~55 min to target',
      ordersCompleted: 7,
      onlineHours: 4.5,
      aiInsight:
        "Westlands lunch rush volume is up 15%. Two more orders (~55 min) will hit today's KSh 5,500 target.",
    },
    ...
    incomeRecords: [
      ...
      { recordId: 'rec_n3', riderId: 'rider_aminu', type: 'expense', category: 'fuel', amount: 450, timestamp: iso(-250), note: 'Fuel 2L' },
      ...
      { recordId: 'rec_n6', riderId: 'rider_aminu', type: 'expense', category: 'food', amount: 350, timestamp: iso(-130), note: 'Lunch' },
    ...
    incomeTrend: {
      ...
      week: [
        { label: 'Mon', income: 4800, expense: 1800 },
        { label: 'Tue', income: 4500, expense: 1600 },
        { label: 'Wed', income: 5200, expense: 1900 },
        { label: 'Thu', income: 4100, expense: 1500 },
        { label: 'Fri', income: 5800, expense: 2100 },
        { label: 'Sat', income: 6500, expense: 2300 },
        { label: 'Sun', income: 5100, expense: 1900 },
      ],
      month: [
        { label: 'Week 1', income: 32000, expense: 11500 },
        { label: 'Week 2', income: 34500, expense: 12200 },
        { label: 'Week 3', income: 30000, expense: 10800 },
        { label: 'Week 4', income: 36800, expense: 13000 },
      ],
    },
    incomeSummary: {
    ...
    repaymentAnalysis: {
      ...
      attainmentRate: 0.85,
      gap: -100,
      overtimeSuggestion: 'About KSh 100 short this week — one evening-rush order should cover it.',
    },
  ...
  abuja: {
    ...
    todaySnapshot: {
      dailyIncome: 5800,
      todayTarget: 6500,
      dailyEta: '~35 min to target',
      ordersCompleted: 8,
      onlineHours: 5,
      aiInsight:
        "Wuse zone density is high; avg distance is 12% shorter than Lagos. One more order (~35 min) will hit today's ₦6,500 target.",
    },
    ...
    incomeRecords: [
      ...
      { recordId: 'rec_a3', riderId: 'rider_aminu', type: 'expense', category: 'fuel', amount: 1000, timestamp: iso(-260), note: 'Fuel 2.5L' },
      ...
      { recordId: 'rec_a6', riderId: 'rider_aminu', type: 'expense', category: 'food', amount: 500, timestamp: iso(-140), note: 'Lunch' },
    ],
    incomeTrend: {
      today: [
      ...
      week: [
        { label: 'Mon', income: 6500, expense: 2300 },
        { label: 'Tue', income: 6100, expense: 2100 },
        { label: 'Wed', income: 7200, expense: 2500 },
        { label: 'Thu', income: 5500, expense: 2000 },
        { label: 'Fri', income: 8000, expense: 2900 },
        { label: 'Sat', income: 9000, expense: 3200 },
        { label: 'Sun', income: 7000, expense: 2800 },
      ],
      month: [
        { label: 'Week 1', income: 42000, expense: 15000 },
        { label: 'Week 2', income: 45000, expense: 16000 },
        { label: 'Week 3', income: 40000, expense: 14000 },
        { label: 'Week 4', income: 48000, expense: 17000 },
      ],
    },
    incomeSummary: {
    ...
    repaymentAnalysis: {
      ...
      attainmentRate: 0.92,
      gap: 800,
      overtimeSuggestion: 'Already ahead of target — keep your current pace to repay on time.',
    },
